...
<img class="vacancy__logo" src="${API_URL}${
  vacancy.logo
...
<ul class="vacancy__fields">
    <li class="vacancy__wage vacancy__field">от ${(+vacancy.salary).toLocaleString()}₽</li>
    <li class="vacancy__type vacancy__field">${vacancy.type}</li>
    <li class="vacancy__format vacancy__field">${vacancy.format}</li>
    <li class="vacancy__expirience vacancy__field">${vacancy.experience}</li>
</ul>
    ...
    <article class="detail">
        ...
        <div class="detail__info">
            ...
            <ul class="detail__fields">
                <li class="detail__field">от ${(+salary).toLocaleString()}₽</li>
      ...
      `
          ...
          <input name="vacancy__id" type="hidden" value="${id}">
...
const init = () => {
  ...
  const filterVacancy = document.querySelector(".vacancies__filter");
  filterBtn.addEventListener("click", () => {
    console.log();
    if (filterBtn.classList.contains("vacancies__filter-btn_active")) {
      filterBtn.classList.remove("vacancies__filter-btn_active");
      filterVacancy.classList.remove("vacancies__filter_active");
    } else {
      filterBtn.classList.add("vacancies__filter-btn_active");
      filterVacancy.classList.add("vacancies__filter_active");
    }
  });
};
